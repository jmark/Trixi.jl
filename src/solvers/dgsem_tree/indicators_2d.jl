...
function create_cache(::Type{IndicatorClamp}, equations::AbstractEquations, basis::LobattoLegendreBasis)
...
function create_cache(typ::Type{IndicatorClamp}, mesh, equations::AbstractEquations, dg::DGSEM, cache)
  cache = create_cache(typ, equations, dg.basis)
end
